...
public class ByteTools {
     ...
     * @param b byte[]
     * @return String
     * @throws UnsupportedEncodingException 编码错误异常抛出
     */
...
//
//        String s = new String("4E01123456780101FF55552222111111111200A8");
//        byte[] bytes1 = getBytesOfTheDateString(s);
//
        System.out.println(Arrays.toString(bytes));
//        System.out.println(Arrays.toString(bytes));
//        System.out.println(bytesToHex(bytes));
//        System.out.println(string2Bytes("4e","UTF-8"));
